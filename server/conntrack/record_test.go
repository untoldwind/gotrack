...
func TestRecord(t *testing.T) {
	Convey("Given a tcp line with accounting to parse", t, func() {
		...
		Convey("When the line is parsed", func() {
			...
			So(record.Send.SrcIp, ShouldEqual, "192.168.3.133")
			So(record.Send.DstIp, ShouldEqual, "84.53.142.43")
			...
			So(record.Receive.SrcIp, ShouldEqual, "84.53.142.43")
			So(record.Receive.DstIp, ShouldEqual, "192.168.2.106")
	...
	Convey("Given an udp line with accounting to parse", t, func() {
		...
		Convey("When the line is parsed", func() {
			...
			So(record.Send.SrcIp, ShouldEqual, "192.168.3.133")
			So(record.Send.DstIp, ShouldEqual, "192.168.3.1")
			...
			So(record.Receive.SrcIp, ShouldEqual, "192.168.3.1")
			So(record.Receive.DstIp, ShouldEqual, "192.168.3.133")
